...
ChartJS.register(
  ...
  Tooltip,
  Legend
);//Registers the required Chart.js components kind of setup
...
const SalesSnapshot = () => {
  ...
  return (
    <div className="p-4 sm:p-6 border-[1px] border-[#39CEF3] shadow-md relative">
      ...
      {/* Wrapper Box */}
      <div className="relative border border-[#39CEF3] bg-white p-4 sm:p-6 rounded-lg w-full sm:w-3/4 lg:w-1/2 h-auto sm:h-[300px] lg:h-[250px] overflow-hidden left-0 mt-16">
        {/* Color Icons */}
